...
class __TwigTemplate_b39cba74bffbaff8a4e960ca3756fff26557107120eb0519fa76bb3a951532ce extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  108 => 14,  103 => 12,  99 => 11,  93 => 7,  91 => 6,  88 => 5,  78 => 4,  59 => 3,  36 => 1,);
    }
...
{% set username = app.session.get('username') %}
    ...
    <div class=\"d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm\">
      <h5 class=\"my-0 mr-md-auto font-weight-normal\">Potato Sales</h5>
      <nav class=\"my-2 my-md-0 mr-md-3\">
        <a class=\"p-2 text-dark\" href=\"{{path('product_new')}}\">New Product</a>
...
{% endblock %}
", "product/index.html.twig", "C:\\Users\\Mazzola\\Documents\\GitHub\\PotatoSales\\patato_sales\\templates\\product\\index.html.twig");
    }
}
